...
class Day:
    ...
    def add_event(self, event_id: str, star_at: time, end_at: time):
        for slot in self.slots:
            if star_at <= slot < end_at:
                if self.slots[slot]:
...
class Calendar:
    ...
    def add_event(self, title: str, description: str, date_: date, star_at: time, end_at: time):
        ...
        event = Event(title, description, date_, star_at, end_at)
        self.days[date_].add_event(event.id, star_at, end_at)
